...
//
///**
// * Created by TooNies1810 on 3/17/16.
// */
//public class FeedFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, TimeLineAdapter.OnBindItemComplete {
//
...
//        mAdapter = new TimeLineAdapter(mainContext, this);
//
//        requestPost(uid);
////        onRefresh();
//    }
...
//    private void requestPost(final String uid) {
...
//
//        StringRequest request = new StringRequest(Request.Method.POST, AppConfig.URL_GET_FEED, new Response.Listener<String>() {
//            @Override
...
//                            ((ItemTimeLine) itemPostArr.get(i)).setKeyLopType(basePost);
//                        }
//                        FeedFragment.this.itemPostArr = itemPostArr;
